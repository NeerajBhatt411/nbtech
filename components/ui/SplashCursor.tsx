    ...
    useEffect(() => {
        ...
        function getWebGLContext(canvas: HTMLCanvasElement) {
            ...
            if (isWebGL2) {
                ...
                formatRG = getSupportedFormat(gl, (gl as WebGL2RenderingContext).RG16F, (gl as any).RG, halfFloatTexType);
                formatR = getSupportedFormat(gl, (gl as WebGL2RenderingContext).R16F, (gl as any).RED, halfFloatTexType);
            } else {
        ...
        class Material {
            ...
            programs: any[];
            activeProgram: any;
            uniforms: any; // Changed from any[] to any
        ...
        function getUniforms(program: WebGLProgram) {
            let uniforms: any = {}; // Initialized as object
    ...
    `;
      ...
      `
        ...
        function resizeFBO(target: any, w: number, h: number, internalFormat: number, format: number, type: number, param: number) {
            ...
            copyProgram.bind();
            const uTextureLoc = (copyProgram.uniforms as any).uTexture;
            if (uTextureLoc) gl.uniform1i(uTextureLoc, target.attach(0));
            blit(newFBO);
            return newFBO;
        }
        ...
        function drawDisplay(target: any) {
            ...
            if (config.SHADING) {
                const texelSizeLoc = (displayMaterial.uniforms as any).texelSize;
                if (texelSizeLoc) gl.uniform2f(texelSizeLoc, 1.0 / width, 1.0 / height);
            }
            const uTextureLoc = (displayMaterial.uniforms as any).uTexture;
            if (uTextureLoc) gl.uniform1i(uTextureLoc, dye.read.attach(0));
            blit(target);
        }
